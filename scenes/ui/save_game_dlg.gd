...
func _on_SaveGame_confirmed() -> void:
...
static func _save(screenshot: Image, checkpoint: bool) -> void:
	...
	var results:Variant = GameStateService.call_thread_safe("save_game_state", save_game_file_name)
...
static func save_checkpoint(screenshot: Image) -> void:
