...
var gamestateinspector_plugin : GameStateInspector 

func _enter_tree() -> void:
	gamestateinspector_plugin = load(GAME_STATE_INSPECTOR_PLUGIN).new()
	add_inspector_plugin(gamestateinspector_plugin)

func _exit_tree() -> void:
	remove_inspector_plugin(gamestateinspector_plugin)
